...
const AREA_HEAD = {
    ...
    tradearea: ["상권 분석",
        "후보지 주소를 넣으면 반경 500m/1km 안 음식점 추정매출·인구를 실시간으로 " +
        "받아 미태리 예상 월매출을 계산합니다. 분석 결과는 이력에 저장되어 " +
        "팀이 함께 봅니다."],
    map: ["매장 지도",
    ...
    stores: ["매장 정보",
        "가맹점 DB(SV 배정·분류·주소)와 채널별 계정(유무·아이디·비밀번호), " +
        "점주 연락처·계약을 조회·수정합니다. 계정과 연락처는 2차 암호로 엽니다."],
    lifecycle: ["오픈·폐점",
